  ...
  <body>
   <table align="center">
			...
			<tr>
				...
				<td colspan="1" width="1200" height="30"><center><u><font size="6" color="#457667"><b><i>Online Travel Agency</i></b></font></u></center></td>
			</tr>
			<tr>
				<td colspan="1" width="1200" height="1" ><img src="<%=request.getContextPath()+"/images/footer3.jpg"%>" height="12" width="1200"/></td>
			</tr>
		</table>
		  <table width="1000">
