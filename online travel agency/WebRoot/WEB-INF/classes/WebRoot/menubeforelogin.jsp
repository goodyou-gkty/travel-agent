...
<li> <a href="<%=request.getContextPath()+"/Home.jsp"%>">HOME</a>
<ul>
</ul>
<li> <a href="<%=request.getContextPath()+"/Services.jsp"%>">SERVICES</a>
<ul>
</ul>
<li> <a href="<%=request.getContextPath()+"/Contactus.jsp"%>">CONTACTUS</a>
<ul>
</ul>

<ul>
</ul>
<li> <a href="<%=request.getContextPath()+"/LoginForm.jsp"%>">LOGIN</a>
<ul>
</ul>
</li>
</ul>
