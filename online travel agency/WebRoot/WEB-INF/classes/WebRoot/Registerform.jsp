...
window.location.href='http://'+host+':'+port+'/Ewheelz/ChekUserAction?userName='+userName;
...
font-size:8pt
		   ...
		   <h3><div align="center"><span class=subHead><br/></span></div></h3>
		   <body>
...
<tr></tr><tr></tr>
 <tr>
    ...
    out.print(request.getParameter("userName")); %>" size="20" onBlur="goOn()"/>
